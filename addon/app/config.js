...
const config = {
  ...
  printer: {
    ...
    webPrntDeviceId: parseOptionalStringEnv('WEBPRNT_DEVICE_ID') || 'local_printer',
    webPrntPaperType: parseOptionalStringEnv('WEBPRNT_PAPER_TYPE') || 'normal',
    webPrntHoldPrintTimeoutMs: parseIntEnv('WEBPRNT_HOLDPRINT_TIMEOUT_MS', 10000),
