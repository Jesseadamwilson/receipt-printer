...
export WEBPRNT_DEVICE_ID="$(bashio::config 'webprnt_device_id')"
export WEBPRNT_PAPER_TYPE="$(bashio::config 'webprnt_paper_type')"
export WEBPRNT_HOLDPRINT_TIMEOUT_MS="$(bashio::config 'webprnt_holdprint_timeout_ms')"
