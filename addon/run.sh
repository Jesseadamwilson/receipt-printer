...
export TEMPLATE_MESSAGE_PATH="$(bashio::config 'template_message_path')"
export TEMPLATE_DAILY_AGENDA_PATH="$(bashio::config 'template_daily_agenda_path')"
export CUSTOM_CSS_PATH="$(bashio::config 'custom_css_path')"
